    ...
    **Building a 2D Mesh**
    ...
    def save(self, filepath, format='pickle'):
        ...
        if format == 'pickle':
            ...
            #     u.encoding = 'latin1'
            pickle.dump(mesh_dict, open(filepath, "wb"))
    ...
    def _save_pytables(self, filepath):
        ...
        ngids_array = h5f.createCArray(h5f.root, 'node_group_ids', tables.IntAtom(), node_group_ids.shape,
                                       filters=filters)
        ...
        egids_array = h5f.createCArray(h5f.root, 'element_group_ids', tables.IntAtom(), element_group_ids.shape,
                                       filters=filters)
